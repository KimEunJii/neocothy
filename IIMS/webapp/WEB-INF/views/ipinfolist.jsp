					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="insert.do" method="post">
								...
								<label>모델명</label> <input type="text" class="form-control"name="model" /><br>
								<label>사용여부</label>
								...
								<label>사용자</label> <input type="text" class="form-control" name="user" /><br> 
								<label>사용기간</label> <input type="text" class="form-control" name="use_term" /><br> 
								<label>승인일자</label>
								<input type="date"  name="per_date" ng-model="example.value" class="form-control"					
      							 placeholder="yyyy-MM-dd" min="1999-01-01" max="2500-12-31" required/><br>
								<label>수정일자</label> <input type="text" class="form-control" name="mody_date" /><br> 
								<label>비고</label>
