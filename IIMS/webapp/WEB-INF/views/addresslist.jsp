...
<body>
	...
	<form action="insert.do">
		...
		pm_phone : <input type="text" name="pm_phone" />&nbsp pm_email : <input
			...
			name="task" />
		 equipment : <input type="text" name="equipment" />&nbsp
		engineer : <input type="text" name="engineer" />&nbsp engineer_phone :
		<input type="text" name="engineer_phone" />&nbsp engineer_email : <input
			type="text" name="engineer_email" />&nbsp <br> 
			test_date : <input type="text" name="test_date" />
	test_type : <input type="text" name="test_type" />&nbsp
