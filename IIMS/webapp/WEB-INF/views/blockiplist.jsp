              ...
              Search <input ng-model="test" id="search" class="form-control" placeholder="Filter text">
				...
				<table class="table table-striped">
					<tr>
						...
						<th><center>blockIp</center></th>					
						<th></th>
						

					</tr>
		
					<tr ng-repeat="x in blockIp | pagination: curPage * pageSize | limitTo: pageSize | filter:test "
					  id="userIptable" >

						<td><center>{{x}}</center></td>						
						<td><center><button class="btn btn-default" id="plus" ng-click="do_some_action(x)">해제</button></center></td>
				...
				<center>
				<div class="pagination pagination-centered" ng-show="blockIp.length">
					<ul class="pagination-controle pagination">
	 					...
	 					<li>
	 						<button type="button" class="btn btn-primary" ng-disabled="curPage >= blockIp.length/pageSize - 1" ng-click="curPage = curPage+1">NEXT &gt;</button>
	 					</li>
					</ul>
				</div>
				</center>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="form-group">
									 <form action="deleteBlockIp.do">
									 <input type="hidden" name="block_ip" value="{{x}}" />
										<center>해제하시겠습니까?</center>
							</div>
						...
						<div class="modal-footer">
							...
							<input type="submit" class="btn btn-primary" value="해제"/>
							</form>
