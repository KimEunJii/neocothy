            ...
            <ul class="nav nav-stacked">
                <li class="nav-header"> <a href="#" data-toggle="collapse" data-target="#userMenu">Settings <i class="glyphicon glyphicon-chevron-down"></i></a>
                    <ul class="nav nav-stacked collapse in" id="userMenu">
                        <li class="active"> <a href="#"><i class="glyphicon glyphicon-home"></i> IP 정보관리</a></li>
                        ...
                        <li><a href="/management/maintain_list.do"><i class="glyphicon glyphicon-flag"></i> 정기점검 관리</a></li>
                        <li><a href="#"><i class="glyphicon glyphicon-exclamation-sign"></i> 자료실</a></li>
                        <li><a href="#"><i class="glyphicon glyphicon-off"></i> 보안계 업무관리</a></li>
                    </ul>
                </li>
