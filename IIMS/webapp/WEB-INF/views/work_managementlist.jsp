				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							date: {{x.date}} <br> 
							equipment: {{x.equipment}} <br>
							title:{{x.title}}<br> 
							contents: {{x.contents}} <br>
							note: {{x.note}}<br> 
							<input type="hidden" name="category" value="work">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							date: <input type="text" name="date" value="{{x.date}}" /> <br> 
							equipment: <input type="text" name="equipment" value="{{x.equipment}}"  /> <br>
							title:<input type="text" name="title" value="{{x.title}}" /><br> 
							contents: <input type="text" name="contents" value="{{x.contents}}" size="20" /> <br>
							note: <input type="text" name="note" value="{{x.note}}" /><br> 
